...
import { products as seed, categories, type Product } from "@/lib/mock-data";
...
function statusOf(p: Product) {
  if (p.stock === 0) return { label: "Out of stock", variant: "destructive" as const };
  if (p.stock <= p.reorderLevel) return { label: "Low stock", variant: "secondary" as const };
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-end justify-between gap-3">
        ...
        <Button onClick={() => toast.info("Open the add-product form")}>
        ...
        <CardHeader className="gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex flex-col gap-2 sm:flex-row">
            <div className="relative">
              ...
              <Input value={q} onChange={(e) => setQ(e.target.value)} placeholder="Search by name or SKU" className="pl-9 sm:w-72" />
            </div>
